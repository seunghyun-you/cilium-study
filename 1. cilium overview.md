...
- [Cilium Components](#cilium-components)
  - [1. Cilium Components Diagram](#1-cilium-components-diagram)
    - [1.1 Cilium Operator](#11-cilium-operator)
    - [1.2 Cilium CNI Plug-in (Node Level 작업)](#12-cilium-cni-plug-in-node-level-작업)
    - [1.3 Cilium Agent (Kernel Level 작업, L3~4 계층)](#13-cilium-agent-kernel-level-작업-l34-계층)
    - [1.4 Envoy Proxy (UserSpace 작업, L7 계층)](#14-envoy-proxy-userspace-작업-l7-계층)
  - [2. Cilium CLI \& Debugging Tool](#2-cilium-cli--debugging-tool)
- [Network 구성](#network-구성)
  - [1. Network Interface 구조](#1-network-interface-구조)
    - [1.1 cilium\_host](#11-cilium_host)
    - [1.2 cilium\_net](#12-cilium_net)
    - [1.3 cilium\_health (lxc\_health)](#13-cilium_health-lxc_health)
    - [1.4 lxcxxxxx](#14-lxcxxxxx)
  - [2. Cilium Network interface 세부 정보 조회](#2-cilium-network-interface-세부-정보-조회)
    - [2.1 Cilium의 `endpointRoutes.enabled` 옵션을 이용한 정보 조회](#21-cilium의-endpointroutesenabled-옵션을-이용한-정보-조회)
    - [2.2 Cilium 디버깅용 CLI를 통한 정보 조회](#22-cilium-디버깅용-cli를-통한-정보-조회)
  - [3. eBPF Datapath (Packet Flow)](#3-ebpf-datapath-packet-flow)
    - [3.1 같은 노드에 배치된 Pod 간의 Datapath](#31-같은-노드에-배치된-pod-간의-datapath)
    - [3.2 Pod에서 외부로 나가는 트래픽의 Datapath](#32-pod에서-외부로-나가는-트래픽의-datapath)
    - [3.3  Pod 내부로 들어오는 트래픽의 Datapath](#33--pod-내부로-들어오는-트래픽의-datapath)
  - [4. Datapath 과정에 사용되는 eBPF Program의 상세 정보 조회 방법](#4-datapath-과정에-사용되는-ebpf-program의-상세-정보-조회-방법)
    - [4.1 eBPF Program 정보 조회](#41-ebpf-program-정보-조회)
    - [4.2 Pod 인터페이스에 할당되는 eBPF Program 세부 정보 조회](#42-pod-인터페이스에-할당되는-ebpf-program-세부-정보-조회)

---

# Overview
<img src="./_images/cilium_overview.png" width="600">
...
<img src="./_images/cilium_components_diagram.png" width="600">

### 1.1 Cilium Operator
<img src="./_images/cilium_operator.png" width="600">
...
<img src="./_images/cilium_cni_flow.png" width="600">
...
<img src="./_images/cilium_agent_flow.png" width="600">
...
<img src="./_images/network_interface_structure.png" width="600">
### 1.1 cilium_host
...
<img src="./_images/datapath_same_node.png" width="600">

### 3.2 Pod에서 외부로 나가는 트래픽의 Datapath
<img src="./_images/datapath_egreee_traffic.png" width="600">

### 3.3  Pod 내부로 들어오는 트래픽의 Datapath
<img src="./_images/datapath_ingress_traffic.png" width="600">
